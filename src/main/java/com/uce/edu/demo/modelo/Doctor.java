...
public class Doctor {
	...
	@Id
	@Column(name="doct_id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "doct_name_gerneration")
	@SequenceGenerator(name = "doct_name_gerneration",sequenceName = "doct_id_seq", allocationSize = 1)
	private Integer id;
